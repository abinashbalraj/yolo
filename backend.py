...
FULL_YOLO_BACKEND_PATH  = "trained_wts.h5"   # should be hosted on a server
TINY_YOLO_BACKEND_PATH  = "trained_wts.h5"   # should be hosted on a server
SQUEEZENET_BACKEND_PATH = "trained_wts.h5"  # should be hosted on a server
MOBILENET_BACKEND_PATH  = "trained_wts.h5"   # should be hosted on a server
INCEPTION3_BACKEND_PATH = "trained_wts.h5"   # should be hosted on a server
VGG16_BACKEND_PATH      = "trained_wts.h5"       # should be hosted on a server
RESNET50_BACKEND_PATH   = "trained_wts.h5"    # should be hosted on a server
